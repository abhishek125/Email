				...
				<div class="inbox-body">
					<div class="mail-option">
						...
						<div class="btn-group hidden-phone">
							...
							<ul class="dropdown-menu">
								<li>
									<button class="btn btn-link" onclick="changeStatus('READ')">
										<i class="fa fa-pencil"></i>
										Mark as Read
									</button>
								</li>
								<li>
									<button class="btn btn-link" onclick="changeStatus('UNREAD')">
								...
								<li class="divider"></li>
								<li>
									<button class="btn btn-link" onclick="changeStatus('FLAGGED')">
