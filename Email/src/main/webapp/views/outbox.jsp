...
${profile.firstname} ${profile.lastname}
	...
	<ul class="inbox-nav inbox-divider">
		<li ><a href="${pageContext.request.contextPath}/inbox"><i class="fa fa-inbox"></i> Inbox <span class="label label-danger pull-right">${inboxCount}</span></a></li>
		<li class="active"><a href="${pageContext.request.contextPath}/outbox"><i class="fa fa-envelope-o"></i> Sent Mail <span class="label label-danger pull-right">${outboxCount}</span></a></li>
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                             <div class="chk-all">
                                 ...
                                 <div class="btn-group">
                                     ...
                                     <ul class="dropdown-menu">
                                          <li><button class="btn btn-link" onclick="none('true')"> None</button></li>
                                         <li><button class="btn btn-link" onclick="read('true')"> Read</button></li>
                                         <li><button class="btn btn-link" onclick="unread('true')"> Unread</button></li>
                                     </ul>
                                 </div>
                             </div>
                             ...
                             <div class="btn-group hidden-phone">
                                 ...
                                 <ul class="dropdown-menu">
                                 <li><button class="btn btn-link" onclick="changeStatus('READ')"><i class="fa fa-pencil"></i> Mark as Read</button></li>
                                     <li><button class="btn btn-link" onclick="changeStatus('UNREAD')"><i class="fa fa-envelope"></i> Mark as Unread</button></li>
                                     <li class="divider"></li>
									  <li><button class="btn btn-link" onclick="changeStatus('FLAGGED')"><i class="fa fa-star"></i> important</button></li>
                                     <li><button class="btn btn-link" onclick="changeStatus('DELETED')"><i class="fa fa-trash-o"></i> Delete</button></li>
                                 </ul>
                             </div><span id="dynamicstatus"></span>
                          ...
                          <table class="table table-inbox table-hover">
                           ...
                           <fmt:formatDate value="${object.dateSent}" var="myVar"
                			type="date" pattern="MMM dd, yyyy" />
                              <tr id="my${object.messageId}" onclick="showit('${object.messageId}')" class="${fn:toLowerCase(object.senderRead)}">
                                  <td>
                              ...
                              <a href="${files}">${fn:substringAfter(files, "/uploads/")} </a><br/>
                            </c:forEach>
                            </c:if>
                              </div>
                              </td>
