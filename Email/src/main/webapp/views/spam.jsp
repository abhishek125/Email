...
${profile.firstname} ${profile.lastname}
	...
	<ul class="inbox-nav inbox-divider">
		...
		<li class="active"><a href="${pageContext.request.contextPath}/spam"><i class=" fa fa-external-link"></i> spam <span	class="label label-danger pull-right">${spamCount}</span></a></li>
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                             ...
                             <div class="btn-group hidden-phone">
                                 ...
                                 <ul class="dropdown-menu">
                                     <li><button class="btn btn-link" onclick="changeStatus('UNSPAM')"><i class="fa fa-edit"></i>not spam</button></li>
