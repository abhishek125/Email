...
${profile.firstname} ${profile.lastname}
	...
	<ul class="inbox-nav inbox-divider">
		...
		<li class="active"><a href="${pageContext.request.contextPath}/trash"><i class=" fa fa-trash-o"></i> Trash <span class="label label-danger pull-right">${trashCount}</span></a></li>
	</ul>
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                             ...
                             <div class="btn-group hidden-phone">
                                 ...
                                 <ul class="dropdown-menu">
                                     <li><button class="btn btn-link" href="#" onclick="changeStatus('UNDELETE')" ><i class="fa fa-edit"></i> undelete </button></li>
                                     <li class="divider"></li>
                                     <li><button class="btn btn-link" onclick="changeStatus('SPAM')"><i class="fa fa-ban"></i> Spam</button></li>
                                     <li><button class="btn btn-link" onclick="changeStatus('NULL')"><i class="fa fa-trash-o"></i> Delete forever</button></li>
                                 </ul>
