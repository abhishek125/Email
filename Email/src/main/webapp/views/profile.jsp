...
<body>
	...
	<div class="row">
		<div class="mail-box">
			...
			<!-- sidebar ends -->
			<aside>
				<form class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath}/profileupdate?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
					<fmt:formatDate value="${profile.dob}" var="formattedDate" type="date" pattern="yyyy-MM-dd" />
					<!-- left column -->
					...
					<div class="col-md-8 col-sm-6 col-xs-12 personal-info">
						<div id="updateinfo" class="alert alert-info alert-dismissable">${updated}</div>
						<h3>Personal info</h3>
						<div class="form-group">
