...
<!-- message editor starts -->
	...
	<ul class="inbox-nav inbox-divider">
		...
		<li class="active"><a href="${pageContext.request.contextPath}/flagged"><i class="fa fa-bookmark-o"></i> Important <span class="label label-danger pull-right">${flaggedCount}</span></a></li>
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                             ...
                             <div class="btn-group hidden-phone">
                                 ...
                                 <ul class="dropdown-menu">
                                     <li><button class="btn btn-link" onclick="changeStatus('UNFLAGGED')"><i class="fa fa-edit"></i> not important</button></li>
                                     <li><button class="btn btn-link" onclick="changeStatus('SPAM')"><i class="fa fa-ban"></i> Spam</button></li>
                                     <li class="divider"></li>
                           ...
                           <fmt:formatDate value="${object.dateSent}" var="myVar"
                			type="date" pattern="MMM dd, yyyy" />
                              ...
                              <input type="hidden" value="${object.messageId}" />
                                  ...
                                  <td ><i class="fa fa-star" style="color:#f78a09;"></i></td>
